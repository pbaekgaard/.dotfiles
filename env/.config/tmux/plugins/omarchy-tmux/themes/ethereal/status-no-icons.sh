...
tmux set -g @prefix_highlight_output_prefix "#[fg=${PALETTE[blue5]}]#[bg=${PALETTE[bg]}]"
...
#[fg=${PALETTE[white]},bg=${PALETTE[blue7]}] ${DATE_FORMAT} \
#[fg=${PALETTE[white]},bg=${PALETTE[blue7]}] ${TIME_FORMAT} \
#[fg=${PALETTE[bg]},bg=${PALETTE[blue]},bold] #H "

# Windows
tmux set -g window-status-format "\
#[fg=${PALETTE[white]},bg=${PALETTE[blue]}] #I \
#[fg=${PALETTE[white]},bg=${PALETTE[blue]}] #W #F \
#[fg=${PALETTE[green]},bg=${PALETTE[bg]}]"

tmux set -g window-status-current-format "\
#[fg=${PALETTE[bg]},bg=${PALETTE[yellow]}] #I \
#[fg=${PALETTE[bg]},bg=${PALETTE[yellow]}] #W #F \
